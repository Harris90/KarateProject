Feature: JMS REST API - Test Suite 19
  ...
  Scenario: Producing & Consuming Message
    ...
    And param destination = "queue://prasad.input"
    And header Connection = "Keep-Alive"
    And request "Hi Hari prasad, Karate - JMS"
    When method post
    Then status 200
    ...
    * waitForMiliseconds(1000)
    ...
    Given path "/api/message/prasad.input"
    ...
    * print responseType
    * print response
    * match response contains "Hi Hari prasad, Karate - JMS"